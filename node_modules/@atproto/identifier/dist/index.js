...
__export(src_exports2, {
  ...
  NoHandleRecordError: () => NoHandleRecordError,
  ReservedHandleError: () => ReservedHandleError,
  UnsupportedDomainError: () => UnsupportedDomainError,
  ensureHandleServiceConstraints: () => ensureHandleServiceConstraints,
  ...
  fulfillsHandleServiceConstraints: () => fulfillsHandleServiceConstraints,
...
var NoHandleRecordError = class extends Error {
};
...
var ensureHandleServiceConstraints = (handle, availableUserDomains, reserved = reservedSubdomains) => {
...
var fulfillsHandleServiceConstraints = (handle, availableUserDomains, reserved = reservedSubdomains) => {
  try {
    ensureHandleServiceConstraints(handle, availableUserDomains, reserved);
  } catch (err) {
    if (err instanceof InvalidHandleError || err instanceof ReservedHandleError || err instanceof UnsupportedDomainError) {
      return false;
    }
    throw err;
  }
...
0 && (module.exports = {
  ...
  fulfillsHandleServiceConstraints,
  isValidHandle,
