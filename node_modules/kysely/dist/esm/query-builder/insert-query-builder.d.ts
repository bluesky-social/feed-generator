...
import { AnyRawBuilder, MergePartial, SingleResultType } from '../util/type-utils.js';
...
export declare class InsertQueryBuilder<DB, TB extends keyof DB, O> implements ReturningInterface<DB, TB, O>, OperationNodeSource, Compilable, Explainable {
    #private;
