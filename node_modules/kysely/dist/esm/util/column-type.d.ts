 ...
 * ```
 */
export declare type ColumnType<SelectType, InsertType = SelectType, UpdateType = SelectType> = {
 ...
 * ```
 */
export declare type Generated<S> = ColumnType<S, S | undefined, S>;
/**
 ...
 * is allowed.
 */
export declare type GeneratedAlways<S> = ColumnType<S, never, never>;
/**
...
export declare type SelectType<T> = T extends ColumnType<infer S, any, any> ? S : T;
export declare type InsertType<T> = T extends ColumnType<any, infer I, any> ? I : T;
export declare type UpdateType<T> = T extends ColumnType<any, any, infer U> ? U : T;
/**
 * Keys of `R` whose `InsertType` values can be `null` or `undefined`.
 */
export declare type NullableInsertKeys<R> = {
    [K in keyof R]: IfNullable<InsertType<R[K]>, K>;
}[keyof R];
/**
 * Keys of `R` whose `InsertType` values can't be `null` or `undefined`.
 */
export declare type NonNullableInsertKeys<R> = {
 ...
 */
export declare type UpdateKeys<R> = {
 ...
 * ```
 */
export declare type Selectable<R> = {
 ...
 * ```
 */
export declare type Insertable<R> = {
 ...
 * ```
 */
export declare type Updateable<R> = {
